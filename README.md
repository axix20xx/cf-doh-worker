...
> **Note:** This project is based on [tina-hello/doh-cf-workers](https://github.com/tina-hello/doh-cf-workers) with modifications for TypeScript support and environment variable configuration.
...
[![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/Ho3einWave/cf-doh-worker)
